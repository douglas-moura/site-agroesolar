...
;// ./src/assets/helpers/economiaConta.ts
const economiaConta = [
    {
        ContaMensal: 0,
        ContaAnual: 0,
...
;// ./src/assets/helpers/graficoEconomia.ts
        ...
        options: {
            ...
            plugins: {
                ...
                datalabels: {
                    ...
                    align: 'top',
                    formatter: (dados) => `${dados.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' })}`,
                }
            },
            elements: {
                point: {
